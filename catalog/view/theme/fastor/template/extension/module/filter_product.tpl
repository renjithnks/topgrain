			    			...
			    			<div class="col-sm-<?php echo $class; ?> col-xs-6 <?php if($class == 2) { echo 'col-md-25 col-lg-2 col-sm-3 '; } if($class == 2 && $r == 0) { echo 'hidden-md hidden-sm'; } if($class == 2 && $r == 5) { echo 'hidden-sm'; } ?> <?php if($class == 25) { echo 'col-md-25 col-lg-25 col-sm-3 '; } if($class == 25 && $r == 0) { echo 'hidden-sm'; } ?>">
			    				<?php 
			    					if( $tabs[0]['title'] == 'most_viewed') {
				    					include('catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/template/new_elements/product.tpl'); 
				    				} else {
				    					include('catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/template/new_elements/latest.tpl'); 
				    				}
			    					?>
			    			</div>
						<?php $i++; } ?>
...
<?php 
	if( $tabs[0]['title'] == 'most_viewed') { ?>
		...
		<div class="box featured-products-section clearfix box-with-products <?php if($carousel != '0') { echo 'with-scroll';  } ?> box-no-advanced">
		  <?php if($carousel != 0) { ?>
		  <!-- Carousel nav -->
...
?>
		...
		<div class="box new-arrivals-section clearfix box-with-products <?php if($carousel != '0') { echo 'with-scroll';  } ?> box-no-advanced">
		  <?php if($carousel != 0) { ?>
		  <!-- Carousel nav -->
		  <a class="next" href="#myCarousel<?php echo $id; ?>" id="myCarousel<?php echo $id; ?>_next"><span></span></a>
		  <a class="prev" href="#myCarousel<?php echo $id; ?>" id="myCarousel<?php echo $id; ?>_prev"><span></span></a>
